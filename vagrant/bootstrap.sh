...
apt-get update
apt-get install -y build-essential unzip libdb-dev libsodium-dev zlib1g-dev libtinfo-dev solc sysvbanner wrk libleveldb-dev

# apt-get install -y npm nodejs-legacy

# install netting dapps
...
# geth retry patch
cd /home/ubuntu/quorum
git apply /vagrant/examples/retry.diff
